...
import com.xma.tinnews.databinding.SavedNewsItemBinding;
...
public class SavedNewsAdapter extends RecyclerView.Adapter<SavedNewsAdapter.SavedNewsViewHolder>  {
    ...
    interface ItemCallback { // 不用管怎么实现的, 可移植性好,
    ...
    public void setArticles(List<Article> newsList) {
        ...
        notifyDataSetChanged(); //update, notify recycle view to update the views
    }
