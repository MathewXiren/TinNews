...
import com.xma.tinnews.TinNewsApplication;
import com.xma.tinnews.database.TinNewsDatabase;
...
public class NewsRepository {
    ...
    public LiveData<List<Article>> getAllSavedArticles() {
        return database.articleDao().getAllArticles();// no data racing
    }
    ...
    // Async save data, background operate
